...
# 1.x.0 Auto-Elevate PowerShell script if not already
...
# 1.x.0 Set log file path
$global:logFilePath = "$env:TEMP\InstallPowerShellModules" + "_(" + $env:COMPUTERNAME + ").txt"
$separator = "===================================================================="

# 1.x.0 Get Modules to be installed or updated to the latest version
